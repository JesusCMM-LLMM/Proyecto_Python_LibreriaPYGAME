...
Pokémon Matching Cards es un juego de memoria desarrollado en Python con temática Pokémon. El jugador debe encontrar todas las parejas de cartas en el menor tiempo posible y con el menor número de intentos. El tablero contiene 16 cartas (8 parejas) dispuestas boca abajo. En cada turno se voltean dos cartas: si coinciden, permanecen visibles; si no, se vuelven a ocultar tras 1,5 segundos.
